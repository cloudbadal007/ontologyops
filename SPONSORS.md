...
OntologyOps is made possible by the generous support of:

## 💎 Diamond Sponsors ($500+/month)
...
Thank you to all our individual sponsors!
...
- Maintain and improve OntologyOps
- Provide free support to the community
...
Interested in corporate sponsorship? Contact: cloudpankaj@example.com

## Open Source Credits

OntologyOps builds on the excellent work of:

- [RDFLib](https://github.com/RDFLib/rdflib) - RDF library for Python
- [OWL-RL](https://github.com/RDFLib/OWL-RL) - OWL 2 RL reasoning
